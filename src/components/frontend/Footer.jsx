...
export default function Footer() {
  return (
    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        <p className="text-sm text-center text-gray-600"> © Copyright 2024, All Rights Reserved by <Link href="https://hygienichost.com" target="_blank"> HygienicHost </Link> & <Link href="https://bhumihost.com" target="_blank"> BhumiHost </Link>
        </p>
    </div>
</section>
