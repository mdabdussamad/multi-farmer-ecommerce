...
export async function POST(request) {
    try {
        ...
        if (role === "FARMER") {
            ...
            const description =
                "Thank you, for Creating an Account with Us. We request you to click on the link below in order to Complete your onboarding Process. Thanks";
            const subject = "Account Verification - Hygienic Ecommerce";
